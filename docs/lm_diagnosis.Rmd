...
El modelo se basa en $u_i \sim N(0,\sigma^2)$. Esta hipótesis implica:
...
Debido a que $u \sim N(0,\sigma^2 I)$, los residuos tienen distribución $u \sim N(0,\sigma^2 (I - H)$ puesto que
