...
Por ejemplo, imaginemos un solo nodo en $x_i = a$. A la izquierda de a la spline es:
...
Tres nodos y splines cúbicos originan una base de tamaño *k+3* (*k* nodos originan *k+4* parámetros y *k+3* funciones base!):
