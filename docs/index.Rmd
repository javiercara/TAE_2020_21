...
3. Aplicaciones del modelo de regresión lineal
    ...
    b. [Esplicación de relaciones entre variables](lm_aplicaciones_explicacion.html) [(pdf)](lm_aplicaciones_explicacion.pdf)
4. Diagnosis
...
9. Apéndices
    ...
    b. [Matriz de covarianzas](apendice_derivadas.html) [(pdf)](apendice_derivadas.pdf)
